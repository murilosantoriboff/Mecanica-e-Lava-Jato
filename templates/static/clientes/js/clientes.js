...
function dados_cliente() {
    ...
    fetch('/clientes/atualiza_clientes/', {
        ...
        for(i=0; i<data['carros'].length; i++){
            ...
            div_carros.innerHTML += "<form action='/clientes/uptade_carro/"+ data['carros'][i]['id']+"' method='POST'>\
            <div class='row'>\
                <div class='col-md'>\
                ...
                <div class='col-md'>\
                    <a class='btn btn-danger' href='/clientes/excluir_carro/"+ data['carro'][i]['id'] + "'>EXCLUIR</a>\
                </div>\
            </form>\
            </div><br>"
